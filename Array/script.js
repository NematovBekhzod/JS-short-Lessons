...
const arrays = ["Ansor", 20, "Nematov", false, 
    {fName : "Begzod"},
    function siHello() {
...
arr.splice(1, 0, 2) //? Array Xohlagan Joydan Qo'shish birinchi qiymat qaysi index'dan boshlab Qo'shish ikkinchi qiymat arraydan nechta o'chirish uchinchi qiymat esa arrayga necgta qo'shish
console.log(arr); */
